...
def calculate_homography(in_pts, out_pts):
    """
    in_pts = H*out_pts
    :param in_pts: correspond to src [[x1, y1], [x2, y2]...]
    :param out_pts: [[x1, y1], [x2, y2]...]
    :return:
    """
...
def convert_to_homogenous_crd(inp, axis=1):
    ...
    :param inp:
    :param axis:
    axis=1 => the output HC coordinates would be rows of [x1, y1, 1],
    axis=0 => the output HC coordinates would be cols of [x1, y1, 1]
    :return:
    """
